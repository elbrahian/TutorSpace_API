...
**Impacto:** BCrypt con factor 10 hace que cada intento de verificación tome ~100ms en hardware moderno, neutralizando ataques de fuerza bruta offline incluso si la base de datos fuera comprometida. El salt aleatorio por contraseña previene el uso de rainbow tables.
