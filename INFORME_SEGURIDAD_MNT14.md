...
- El perfil `dev` es funcionalmente equivalente al perfil `zap` descrito en GCS-03: usa H2 file-based (`jdbc:h2:file:./tutorspacedev`) aislado de datos reales
...
```
spring.datasource.url=jdbc:postgresql://tutorspace-brahianrueda123-cd6c.i.aivencloud.com:22148/defaultdb
